...
@section('title', 'Form Tambah Siswa - ' . $pengaturan['app_name'])
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('akun-siswa.tambah') }}" method="POST" id="formTambahSiswa">
            @csrf
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="d-flex align-items-center border px-1 py-0" style="height: 38.95px; width: 100%;">
                                <select name="id_kelas" id="kelas" class="form-select border-0" style="box-shadow: none;" required></select>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input
                                ...
                                name="tahun_masuk" value="{{ old('tahun_masuk', date('Y')) }}" required />
                        </div>
                    </div>
                </div>
            </div>
